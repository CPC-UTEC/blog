...
be able to handle multiples queries in a optimal way. Then, we want to store
an array where we can get wheter or not a number is prime.

We can use a simple idea to achieve that. We will initiate with an array where
every element is true (it will represent if the number is prime or not). Then
...
We can use this idea and implement an algorithm two obtain such array. The
...
<div class="topic">$\sigma_{0}(n) = O(\sqrt[3]{n})$ </div>

There are some problems that look like a brute force solution would give a Time
...
problem of this kind in one of your daily problems.

Recommended readings:

- Competitive Programming 3, secci ́on 3.2 y 5.5.1
...
- [Codeforces - Counting Divisors of a Number inO(3√n) - Tutorial](https://codeforces.com/blog/entry/22317)


<div class=topic><a href="https://vjudge.net/contest/352372">Contest</a></div>
