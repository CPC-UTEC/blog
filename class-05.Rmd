...
Notice, for example, how    $two \cdot three \geq L$ may produce overflow but $two \geq \frac{L}{three}$ will not.
...
<div style="float: right;" class="pt-3">	
  ...
  <a href="./class-06.html">Next</a>
  </button>
</div>

<div class="pt-3">
  <button class="continue-link">
  <a href="./class-04.html">Previous</a>
  </button>
</div>
