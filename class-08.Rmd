...
$O(n 2 ^ n)$. This is a solution using what is known as `backtrackin`. In
...
Do problem of generating all the permutations can also be easily computed using
...
You may also be interested in watching the documental of AlphaGo. [Here](https://youtu.be/8tq1C8spV_g) is the trailer.
