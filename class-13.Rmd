...
We can define a function $f: \mathbb{N \bigcup \{0\}} \to \{L, R\}$ such that 
...
Now, lest practice solving [UVA 10404 - Bachet's game](https://onlinejudge.org/index.php?option=com_onlinejudge&Itemid=8&page=show_problem&problem=1345).
